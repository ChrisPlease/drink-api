...
import { Drink as DrinkModel, Drink as BaseDrinkModel, Drink as MixedDrinkModel, Nutrition as NutritionModel } from '/opt/nodejs/node_modules/.prisma/client';
...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  ...
  Ingredient: ( Omit<AbsoluteIngredient, 'drink'> & { drink?: Maybe<_RefType['DrinkResult']> } ) | ( Omit<RelativeIngredient, 'drink'> & { drink?: Maybe<_RefType['DrinkResult']> } );
