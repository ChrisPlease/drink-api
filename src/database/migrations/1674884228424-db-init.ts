...
export class dbInit1674884228424 implements MigrationInterface {
    name = 'dbInit1674884228424'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('CREATE TABLE "entries" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "count" integer DEFAULT \'0\', "drink_id" character varying NOT NULL, "user_id" character varying NOT NULL, "userId" character varying, "drinkId" uuid, CONSTRAINT "UQ_62a9a14d874150617dfa33394c9" UNIQUE ("drink_id", "user_id"), CONSTRAINT "REL_cec0665764a5df83bec3ca74ad" UNIQUE ("drinkId"), CONSTRAINT "PK_23d4e7e9b58d9939f113832915b" PRIMARY KEY ("id"))')
